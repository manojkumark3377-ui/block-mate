...
const AI = () => {
    ...
    const subjectTitle = "Introduction to AI and Applications";
    ...
    if (view === "categories") {
        return (
            <CategoryList
                subjectTitle={selectedModuleTitle}
    ...
    if (view === "new-category") {
        return <NewCategory subjectTitle={selectedModuleTitle} subjectId={subjectData?._id} moduleId={selectedModuleId} onBack={() => setView("categories")} />;
    }
